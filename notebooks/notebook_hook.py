...
class NotebookHook:
    ...
    def _apply_startup(self) -> None:
        ...
        # adjust path: assume math_rag two directories up
    ...
    def _init_containers(self) -> None:
        ...
        # inject into user namespace for direct access
        ...
        # execute async workload via event loop
...
def load_ipython_extension(ipython: InteractiveShell) -> None:
    ...
    Usage:
      # In a notebook cell before loading:
      # RESET = False
