...
class ServerInstance:
    ...
    def start(server_state: ProcessHandler, mount_path: Path, data_path: Path) -> ProcessExitStatus:
        ...
        logger.info(f'Waiting for {TEI_SERVER_INSTANCE_NAME} (TEI) to become healthy...')
        ...
        logger.info(f'Waiting for {TEI_SERVER_INSTANCE_NAME} (Prometheus) to become healthy...')
