...
from math_rag.core.enums import MathExpressionDatasetBuildStage, TaskStatus
...
class MathExpressionDatasetRepository(
    ...
    async def update_task_status(self, id: UUID, task_status: TaskStatus) -> MathExpressionDataset:
        field = 'task_status'
